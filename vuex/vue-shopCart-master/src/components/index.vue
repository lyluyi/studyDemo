          ...
          <div class="detail col-md-6 col-sm-6">
            ...
            <div class="options">
              ...
              <dl class="option dl-horizontal">
                ...
                <dd>
                  <ul>
                    <li v-for="(item, index) in iPhone6S.style"
                        @click="changeStyleActive(item.color, item.url)"
                        :class="{active: iPhone6S.activeStyleUrl == item.url}"><span v-text="item.color"></span></li>
                  </ul>
                </dd>
              </dl>
              <dl class="option dl-horizontal">
                ...
                <dd>
                  <ul>
                    <li v-for="(item, index) in iPhone6S.storage"
                        @click="changePriceActive(item.type,item.price)"
                        :class="{active: iPhone6S.price == item.price}"><span v-text="item.type"></span></li>
                  </ul>
                </dd>
              </dl>
            </div>
...
<script>
  ...
  export default {
    ...
    */
    computed: {
      ...mapGetters([
          'iPhone6S'   // 映射 this.iPhone6S 为 store.getters.iPhone6S  映射 this.iPhone6S 为 store.getters.iPhone6S 
        ])
    },
    methods: {
